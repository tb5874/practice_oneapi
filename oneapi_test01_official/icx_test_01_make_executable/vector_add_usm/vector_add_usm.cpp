...
int main(void) {
    ...
    try {
        ...
        int* a = sycl::malloc_shared<int>(array_size, q);
        int* b = sycl::malloc_shared<int>(array_size, q);
        int* sum_sequential = sycl::malloc_shared<int>(array_size, q);
        int* sum_parallel = sycl::malloc_shared<int>(array_size, q);
